...
import { cleanupTestData, CleanupResult } from '@/db/dev-tools';
    ...
    <ScrollView style={s.root} contentContainerStyle={s.content}>
      ...
      {cleanupResult ? (
        <View style={[s.card, s.cleanCard]}>
          ...
          <Row label="Удалено заправок"  value={String(cleanupResult.deletedFuel)} />
          <Row label="Осталось заправок" value={String(cleanupResult.remainingFuel)} />
          <Row label="Пробег сброшен на" value={`${cleanupResult.odoReset.toLocaleString()} км`} />
        </View>
      ) : (
        <TouchableOpacity
