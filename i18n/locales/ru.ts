...
const ru = {
  ...
  dashboard: {
    ...
    perLiter:        'за литр',
    per100km:        'л/100км',
    // Подсказки под «—» в карточке «Средний расход» (§6.2: нужны два полных бака)
    consHintNoFullTank: 'отметьте «Полный бак» для расчёта',
    consHintNeedSecond: 'нужна ещё одна полная заправка',
  ...
  settings: {
    ...
    editCarNameTitle:    'Название машины',
    carNameError:        'Название не может быть пустым',
  },
  ...
  onboarding: {
    ...
    exit_message:         'Настройка не завершена',
    cancel:               'Отмена',
    exit:                 'Выйти',
  },
